...
#define kBRTMeetingHomeCostCenterCodeKey        @"HomeCostCenterCode"
#define kBRTMeetingHomeCostCenterDescKey        @"HomeCostCenterDesc"
#define kBRTMeetingRegionCodeKey        @"RegionCode"
...
// 2015-04-08, chenxin modified
//@property (nonatomic, weak) BRTMeetingModel *currentMeeting;
@property (nonatomic, strong) BRTMeetingModel *currentMeeting;
